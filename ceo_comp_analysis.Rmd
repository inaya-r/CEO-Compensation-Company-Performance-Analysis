...
summary(raw_data)  # Summary statistics
print(raw_data)  # Quick data preview

numeric_cols <- c("roic", "net_profit_margin", "ebitda_margin", "revenue_growth", 
                   "net_debt", "price_change_ytd", "ev")
...
for (col in numeric_cols) {
  raw_data[[col]] <- convert_negatives_column(raw_data[[col]])
}
...
categorical_cols <- c("Primary_Industry_Group", "HQ_State")  # Adjust as needed
...
write.csv(raw_data, "ceo_comp_data_raw.csv", row.names = FALSE)
